setwd('/Users/farhanhauzannadhir/Documents/R_Projects/Capstone Project Coursera DA/archive/fitbit_longdata_merged')
getwd()
library(dplyr)
...
df_him2 <- read.csv('/Users/farhanhauzannadhir/Documents/R_Projects/Capstone Project Coursera DA/archive/mturkfitbit_export_4.12.16-5.12.16/hourlyIntensities_merged.csv')
